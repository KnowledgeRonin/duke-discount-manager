...
*Para cualquier* operación de actualización del Store, el estado anterior no debe modificarse - las referencias deben ser diferentes y el árbol debe ser clonado.

**Valida: Requisitos 1.1, 1.2, 2.3**

### Propiedad 2: Unicidad de IDs

*Para cualquier* Scene Graph válido, todos los IDs de nodos deben ser únicos - no debe haber duplicados en el árbol completo.

**Valida: Requisitos 11.1, 11.2**

### Propiedad 3: Idempotencia de Undo/Redo

*Para cualquier* secuencia de operaciones, ejecutar undo seguido de redo debe restaurar el estado exacto - el historial debe ser consistente y reversible.

**Valida: Requisitos 9.4, 9.5, 9.8**

### Propiedad 4: Validación Estricta de Tipos

*Para cualquier* actualización de propiedad, si el valor es inválido según el schema Zod del tipo de nodo, la operación debe rechazarse con ZodError y el estado debe permanecer sin cambios.

**Valida: Requisitos 2.1, 2.2, 16.1, 16.2, 16.3**

### Propiedad 5: Integridad Estructural del Árbol

*Para cualquier* operación que modifica la jerarquía (groupNodes, ungroupNodes), el árbol resultante debe ser válido - sin ciclos, sin referencias circulares, y todos los nodos accesibles desde root.

**Valida: Requisitos 11.7, 7.1, 7.7**

### Propiedad 6: Validación de Rangos Numéricos

*Para cualquier* propiedad numérica con restricciones de rango (fontSize, charSpacing, lineHeight, angle, etc.), valores fuera del rango válido deben rechazarse con error de validación.

**Valida: Requisitos 3.2, 3.3, 3.4, 3.5, 5.2, 5.3**

### Propiedad 7: Validación de Estructuras Geométricas

*Para cualquier* nodo de forma geométrica, las propiedades específicas deben cumplir restricciones (rx/ry >= 0, radius > 0, points >= 3, path no vacío y comenzando con 'M').

**Valida: Requisitos 4.1, 4.2, 4.3, 4.4**

### Propiedad 8: Preservación de Posiciones Absolutas en Agrupación

*Para cualquier* conjunto de nodos, al agruparlos y luego desagruparlos, las posiciones absolutas de los nodos deben preservarse (round-trip de coordenadas).

**Valida: Requisitos 7.5, 7.7**

### Propiedad 9: Corrección de Bounding Box

*Para cualquier* conjunto de nodos agrupados, el bounding box del GroupNode debe contener completamente todos los nodos hijos.

**Valida: Requisito 7.4**

### Propiedad 10: Corrección de Reordenamiento Z-Index

*Para cualquier* nodo con hermanos, después de bringToFront debe estar en la última posición del array objects, y después de sendToBack en la primera posición.

**Valida: Requisitos 6.1, 6.2**

### Propiedad 11: Centrado Geométrico Correcto

*Para cualquier* nodo y su padre, después de ejecutar centerNode, el centro geométrico del nodo (considerando dimensiones efectivas y origen) debe coincidir con el centro del padre.

**Valida: Requisitos 8.1, 8.2, 8.3**

### Propiedad 12: Distribución Uniforme

*Para cualquier* conjunto de nodos, después de distributeHorizontally o distributeVertically, la distancia entre centros de nodos consecutivos debe ser uniforme.

**Valida: Requisitos 8.4, 8.5**

### Propiedad 13: Sincronización de Índice

*Para cualquier* operación que modifica el árbol, el índice _nodeIndex debe permanecer sincronizado - findNodeById debe encontrar todos los nodos existentes y retornar null para IDs inexistentes.

**Valida: Requisitos 1.4, 1.5, 20.1, 20.2, 20.4**

### Propiedad 14: Límites de Profundidad y Tamaño

*Para cualquier* Scene Graph, la profundidad no debe exceder 10 niveles y el número total de nodos no debe exceder 1000.

**Valida: Requisitos 11.3, 11.5, 26.1, 26.2**

### Propiedad 15: Round-Trip de Serialización

*Para cualquier* Scene Graph válido, exportar a JSON y luego importar debe producir un Scene Graph equivalente (preservando estructura y propiedades).

**Valida: Requisitos 15.1, 15.2, 14.1**

### Propiedad 16: Atomicidad de Operaciones

*Para cualquier* operación que falla por validación o error, el estado del Store debe permanecer completamente sin cambios (no debe haber modificaciones parciales).

**Valida: Requisitos 2.2, 17.4**

### Propiedad 17: Límite de Historial

*Para cualquier* secuencia de operaciones, la longitud de history.past nunca debe exceder el maxSize configurado.

**Valida: Requisito 9.3**

### Propiedad 18: Validación de Gradientes

*Para cualquier* gradiente, debe tener type válido ('linear' o 'radial'), colorStops no vacío, y cada offset entre 0 y 1.

**Valida: Requisitos 18.2, 18.3, 18.4**

### Propiedad 19: Rechazo de Operaciones Inválidas

*Para cualquier* intento de agrupar nodos con diferentes padres o menos de 2 nodos, la operación debe rechazarse con InvalidOperationError.

**Valida: Requisitos 7.2, 7.3**

### Propiedad 20: Búsqueda Exhaustiva

*Para cualquier* nodo en el Scene Graph, findNodeById debe encontrarlo, y getNodePath debe retornar el camino completo desde root.
